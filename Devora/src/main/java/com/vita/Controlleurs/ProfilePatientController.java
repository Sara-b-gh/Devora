...
public class ProfilePatientController {
    ...
    void haddledeconnexion(ActionEvent event) {
        try {
            ...
            Parent loginRoot = FXMLLoader.load(getClass().getResource("/LoginTest.fxml"));            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public void handleDocDash(ActionEvent actionEvent) {
        switchPage(actionEvent,"/DoctorDashboard.fxml");

    }

    public void handlePatDash(ActionEvent actionEvent) {
        switchPage(actionEvent,"/PatientDashboard.fxml");
    }
